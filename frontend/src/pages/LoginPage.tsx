      ...
      <Container maxWidth="sm">
        ...
        >
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={4}>
            <Stack spacing={3} flex={1} component="form" onSubmit={handleSubmit}>
              <Stack spacing={1}>
                <Typography variant="h4" fontWeight={700}>
                  Bem-vindo de volta
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Faça login com seu e-mail corporativo para acessar o cockpit BankSecure.
                </Typography>
              </Stack>
            ...
            <Divider orientation="vertical" flexItem sx={{ display: { xs: 'none', md: 'block' }, opacity: 0.2 }} />
            ...
            <Stack spacing={2} flex={1}>
              <Stack spacing={0.5}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Clientes podem simular seus produtos antes do login. Consulte os detalhes abaixo.
                </Typography>
              </Stack>
              {isLoadingSeguros ? (
                <LoadingState />
                    ...
                    seguros.map((seguro) => (
                      ...
                      >
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                          Cobertura mínima: {formatCurrency(seguro.coberturaMinima)}
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
                          Prêmio base: {formatCurrency(seguro.valorPremioBase)}
                        </Typography>
                      </Box>
                    ))
                  ) : (
